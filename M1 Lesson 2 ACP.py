...
passenger_name = "Francis Santos"
destination = "England"
ticket_price = 45000.00
number_of_tickets = 3
is_available = True
...
print("Ticket Price After Rs5000 Increase: Rs", ticket_price + 5000)
print("Half Ticket Price: Rs", ticket_price / 2)

print("\nIs ticket price under Rs50000?", ticket_price < 50000)
print("Are more than 2 tickets booked?", number_of_tickets > 2)
print("Is destination England?", destination == "England")
print("Is final cost more than Rs100000?", final_cost > 100000)
...
morning_ticket_price = 42000
evening_ticket_price = 48000
